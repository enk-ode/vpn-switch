...
vpn-switch session switch work       # Stop all active sessions, resume "work"
vpn-switch session switch work home  # Stop only "home", resume "work"
```
...
# Quick switch: stop the active session(s) and resume the target in one step
vpn-switch session switch work
vpn-switch session switch home
```
...
- **One-step switch**: `session switch <name>` stops the active session(s) and resumes `<name>`
