#!/bin/sh
# OpenVPN connection prologue generator
...
#   VPN_SWITCH_PHASES_CONNECT  ordered phase list this prologue heads
...
#
# CUSTOMIZATION:
#   - Edit phase scripts: .include/phase/openvpn/connect/
#   - Edit phase list: .env/local/VPN_SWITCH_PHASES_CONNECT
#   - Edit this prologue: .include/phase/openvpn/connect/prologue.sh
#
# =============================================================================
